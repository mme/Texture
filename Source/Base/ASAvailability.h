...
#define AS_IG_LIST_KIT __has_include(<IGListKit_Converse/IGListKit_Converse.h>)
 ...
 */
#define IG_LIST_COLLECTION_VIEW __has_include(<IGListKit_Converse/IGListCollectionView.h>)
